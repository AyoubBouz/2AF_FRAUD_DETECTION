...
def home():
    return '''<h1>2AF API </h1>
<p> A REST API for the use of Machine learning to detect Credit Cards Frauds.</p>'''
...
def info():
    result = [
        {
            'Author' : 'IOO',
            'description' : 'A fraud detection model using credit card dataset',
        }
    ]
    return jsonify(result)
app.run()
